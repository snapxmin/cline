...
export const formatResponse = {
	...
	semanticCompressionNotice: (summary: string) =>
		`[NOTE] Previous conversation history has been automatically compressed using semantic compression to maintain optimal context window length. Below is a summary of the compressed conversation:\n\n<compressed_summary>\n${summary}\n</compressed_summary>\n\nThe initial user task and the most recent exchanges have been retained for continuity. Please use this summary to understand the context of previous work and continue assisting the user.`,
